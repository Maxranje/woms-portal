...
<section id="content">
	<section class="vbox">
		<header class="header bg-white b-b clear">
			<p>黑白名单 <i class="fa fa-angle-right m-l-sm m-r-sm"></i> 白名单<i class="fa fa-angle-right m-l-sm m-r-sm"></i> 修改白名单 </p>
		</header>		
				...
				<div class="panel-body">
					<form class="form-horizontal ">
						...
						<div class="form-group">
							...
							<div class="col-sm-5"><input type="text" name="content" class="form-control" data-parsley-required="true" data-parsley-length="[17,17]" value="<?=$item['content']?>"></div>
						</div>
						<div class="line line-dashed line-lg pull-in"></div>
						<div class="form-group" >
						...
						<div class="form-group" >
							...
							<div class="col-sm-5">
								<div class="checkbox"><label class="checkbox-custom"><input type="checkbox" name="crossplat" value="o" <?php if($item['crossplat'] == "1") echo "checked='checked'"; ?> >
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<textarea class="form-control text-mt remark" rows="6" data-minwords="6" placeholder="备注信息" name="remark"><?=$item['remark']?></textarea>
							</div>
						</div> 
						<div class="line line-dashed line-lg pull-in"></div>	
						<div class="alert alert-danger col-sm-12 text-mt m-t-lg h6">
							<p>温馨提示：</p>
...
$('.btn-next').on('click', function (){
	...
	zy.send_sync_ajax('/corp/wboptions/whiteedit', $('form').serialize(), function (data){
