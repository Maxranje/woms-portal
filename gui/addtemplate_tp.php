		...
		<aside>
			<section class="vbox">
				<header class="header bg-white b-b clearfix h6">
					<p>模版配置 <i class="fa fa-angle-right m-l-sm m-r-sm"></i> 认证模版配置<i class="fa fa-angle-right m-l-sm m-r-sm"></i> 创建轮播图认证模版 </p>
				</header>
							...
							<div class="wrapper-lg">
								<form class="form-horizontal" method="post" enctype="multipart/form-data">
									...
									<table class="tmp-table" >
										<tr>
											<td>手机背景图1: </td>
											<td><input type="file" name="phonebg1"></td>
										</tr>
										<tr>
											<td>手机背景图2: </td>
											<td><input type="file" name="phonebg2"></td>
										</tr>
										<tr>
											<td>手机背景图3: </td>
											<td><input type="file" name="phonebg3"></td>
										</tr>																													
									</table>
									...
									<table class="tmp-table">
										<tr>
											<td>PC背景图1: </td>
											<td><input type="file" name="pcbg1"></td>
										</tr>
										<tr>
											<td>PC背景图2: </td>
											<td><input type="file" name="pcbg2"></td>
										</tr>
										<tr>
											<td>PC背景图3: </td>
											<td><input type="file" name="pcbg3"></td>
										</tr>																													
									</table>								
									<div class="line line-dashed line-lg pull-in"></div>
