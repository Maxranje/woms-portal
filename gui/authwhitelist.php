					...
					<!-- other button -->
						<div class="col-sm-8 m-b-xs"> 
							<div class="btn-group">		
								...
								<a class="btn btn-sm btn-default m-r-sm"  href="/corp/addwhiteitem"><i class="fa fa-plus m-r-sm"></i>添加</a>
							</div>
						</div>
...
G.set("remove_url", "/corp/wboptions/whiteremove")
	.set('nav_name', 'authwhitelist')
	.set('edit_url', '/corp/editwhiteitem');
...
function initTables (){
	var columns=[
		...
		{field:'wname', title:'	白名单名', width:30, align:'center'},
		{field:'type', title:'白名单类型',width:30, align:'center'},
		{field:'apname', title:'所属接入点', width:20,align:'center'},
		{field:'time', title:'创建时间',width:20, align:'center'},
	...
	createTable($('#table'), '/corp/wboptions/getwhitelist', columns, true);
}
</script>
</body>
</html>