	...
	<section class="vbox">
		<header class="header bg-white b-b clearfix">
			<div class="row m-t-sm"><div class="col-sm-8 m-b-xs l-h-2x">
				<a class="btn btn-sm btn-default m-r-sm refreshs"><i class="fa fa-refresh"></i></a>
			</div></div>
		</header>        
		<section class="scrollable wrapper">
			<section class="panel panel-default">
				<header class="panel-heading font-bold">添加商户</header>
				<div class="panel-body">
					<form role="form">
						<div class="form-group">
							<label><a class="text-danger m-r-sm">*</a>商家昵称</label>
							<input type="text" class="form-control input-sm" data-parsley-required="true" name="nickname">
						</div>
						<div class="form-group">
							<label><a class="text-danger m-r-sm">*</a>登录帐号</label>
							<input type="text" class="form-control input-sm" data-parsley-required="true" name="cpun">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control input-sm" data-parsley-required="true" name="industry">
						</div>
						<div class="form-group">
							<label><a class="text-danger m-r-sm">*</a>负责人姓名</label>
							<input type="text" class="form-control input-sm" data-parsley-required="true" name="name_manager">
						</div>
						<div class="form-group">
							<label><a class="text-danger m-r-sm">*</a>负责人电话</label>
							<input type="text" class="form-control input-sm" data-parsley-required="true" name ="phone">
						</div>	
						<div class="form-group">
							<label>Email</label>
							<input type="email" class="form-control input-sm" data-parsley-type="email" name="email">
						</div>
						<div class="form-group">
							<label>QQ</label>
					...
					<button type="submit" class="btn btn-sm btn-default btn-next m-t">提交</button>
				</div>
			</section>
		</section>
	</section>
...
$('.btn-next').on('click', function (){
	...
	zy.send_sync_ajax('/adc/corpmanage/addcorp', $('form').serialize(), function (data){
